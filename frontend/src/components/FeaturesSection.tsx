...
const features = [
  {
    ...
    description: 'Analyzes 12k+ ingredients against trusted sources and personalizes results to your profile — all in seconds.',
  ...
  },
  {
    ...
    description: 'Instant label OCR with up to 98% character accuracy on clear photos.',
  ...
  },
  {
    ...
    description: 'Explainability built‑in — ask follow‑ups and get cited answers in under 2s.',
    image: '/chat.png',
  ...
  },
  {
    ...
    description: 'Allergy and interaction flags tailored to you — zero guesswork.',
    image: '/alerts.png',
  ...
  },
  {
    ...
    description: 'Download/share concise reports; perfect for doctors, family and records.',
  ...
  },
  {
    ...
    description: 'Personalized alternatives learned from thousands of product comparisons.',
  ...
  },
  {
    ...
    description: 'Regulatory changes and research updates synced daily — always fresh.',
    image: '/realtime.png',
  ...
  },
  {
    ...
    description: 'Trusted by thousands of scans; growing with every analysis you run.',
    image: '/community.png',
